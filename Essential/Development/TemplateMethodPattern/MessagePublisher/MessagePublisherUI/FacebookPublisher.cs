...
{
    public class FacebookPublisher : Network
    {
        public FacebookPublisher(string userName, string password)
        {
        ...
        public override bool SendData(byte[] data)
        {
            ...
            if (messagePosted)
            {
                ...
                Console.WriteLine("Message " + message + " was posted on Facebook");
            }
