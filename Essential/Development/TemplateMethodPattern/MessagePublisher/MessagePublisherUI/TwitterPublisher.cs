...
{
    public class TwitterPublisher : Network
    {
        public TwitterPublisher(string userName, string password)
        {
        ...
        public override bool LogIn(string userName, string password)
        {
            ...
            Console.WriteLine("LogIn success on Twitter");
            return true;
        }
        ...
        public override bool SendData(byte[] data)
        {
            ...
            if (messagePosted)
            {
                ...
                Console.WriteLine("Message " + message + " was posted on Twitter");
            }
