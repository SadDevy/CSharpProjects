...
namespace Analyzer
{
    ...
    public class EmptyStringsAfterAndBeforeBracesCodeFixProvider : CodeFixProvider
    {
        private const string title = "Remove string";

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(EmptyStringsAfterAndBeforeBracesAnalyzer.DiagnosticId); }
        }
