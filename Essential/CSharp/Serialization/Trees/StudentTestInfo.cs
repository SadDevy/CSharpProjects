...
namespace BinaryTee
{
    ...
    public class StudentTestInfo : IComparable<StudentTestInfo>, IEquatable<StudentTestInfo>
    {
        ...
        {
            if (obj == null || !(obj is StudentTestInfo))
                return false;

            StudentTestInfo a = (StudentTestInfo)obj;
            return Equals(a);
        }
        ...
        {
            return Name.GetHashCode() ^ Surname.GetHashCode() ^ TestName.GetHashCode() 
                   ^ PassingDate.GetHashCode() ^ Score.GetHashCode();
        }
    }
}
