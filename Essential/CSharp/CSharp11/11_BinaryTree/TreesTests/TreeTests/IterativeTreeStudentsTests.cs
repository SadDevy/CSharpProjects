...
{
    [TestFixture]
    public class IterativeTreeStudentsTests : IterativeTreeTests<StudentTestInfo>
    {
        [TestCaseSource(nameof(GetTestConstructorWithComparerStudentsTestCases))]
        ...
        public static IEnumerable GetTestConstructorWithComparerStudentsTestCases
        {
            get
            {
